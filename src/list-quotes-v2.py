...
for subdir, dirs, files in os.walk(directory):
    for file in files:
        if file.endswith(".md"):
            ...
            # Extract all the words that start with ";;" or "[;;" from the HTML
            words = [word.translate(str.maketrans("", "", punctuation)) for word in html.split() if word.startswith(";;") or word.startswith("[;;")]
